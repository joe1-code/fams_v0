...
<body style="font-family: 'Segoe UI', sans-serif;">
  ...
  <div class="container-fluid">
    <div class="row flex-nowrap">
      <!-- Sidebar -->
      <div class="col-12 col-md-3 col-lg-2 gradient-bg sidebar d-flex flex-column align-items-center py-4" id="sidebar">
      ...
      <!-- Main Content -->
      <div class="col-12 col-md-9 col-lg-10 py-4" id="main-content">
        @yield('content')
      </div>
    </div>
  </div>
